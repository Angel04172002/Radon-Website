...
import RadonAccordionItemOne from './radon-accordion-item-one/RadonAccordionItemOne';
...
const accordionItems = [
    ...
    //     content: 'Скалите и почвата под домовете ни съдържат следи от уран. С течение на времето уранът се разгражда и образува други елементи. Това се нарича радиоактивно разпадане. Радонът е един от елементите във веригата на разпадане на урана. При разпадането на радон газът излъчва радиация под формата на алфа частици. Тази радиоактивна частица е съставена от два протона и два неутрона.',
    //     renderTimes: 'Two'
    // },
    // {
    //     _id: '3',
    //     title: 'Радон, радиоактивност и ДНК',
    //     content: 'Радоновите потомци могат да се прикрепят към прах и други частици и да бъдат вдишани в белите дробове. При разграждането на радон и неговите потомци във въздуха те излъчват радиация, която може да увреди ДНК в клетките на организма, пише cancer.org.',
    //     renderTimes: 'Three'
    // },
    // {
    //     _id: '4',
    ...
    return (
        ...
        <div className='container mt-5'>
            ...
            <div className="row inner-container2">
                ...
                <p className="display-5">Всичко, което трябва да знаете за радон</p>
